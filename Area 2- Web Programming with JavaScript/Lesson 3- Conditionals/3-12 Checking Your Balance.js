...
//  
// Directions:
// Using the flowchart in this folder, write the code to represent  
...
// represent what should be printed to the console.
// 
...
// 
// Hint: The variable balance could be a value less than, greater than, 
// or equal to 0. The variables isActive and checkBalance are booleans 
// that can be set to true or false.
// 
// TIP: To print out the account balance with decimal points (i.e. 325.00), 
// use the .toFixed() method and pass it the number of decimal points you 
// want to use. For example, balance.toFixed(2) returns 325.00.
// 
